...
namespace Hiring.Web_FinalProject_VisionPlus_ASP.NetCore.Data.Migrations
{
    ...
    [Migration("20211014050606_CreateTabNotifications")]
    partial class CreateTabNotifications
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HiringWeb.DataBase.Models.NotificationsDbEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NotificationTypeDes")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("NotificationsDbEntity");
                });
            ...
            modelBuilder.Entity("HiringWeb.DataBase.Models.NotificationsDbEntity", b =>
                {
                    ...
                    b.HasOne("HiringWeb.DataBase.Models.UserApplication", "UserObject")
                        .WithMany()
                        .HasForeignKey("UserObjectId");

                    b.HasOne("HiringWeb.DataBase.Models.UserApplication", "UserSubject")
                        .WithMany()
